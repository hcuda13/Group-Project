...
mat0 <- combined$CARRIER == "AA"
mat1 <- combined$CARRIER == "MQ"
mat2 <- combined$CARRIER == "9E"
mat3 <-combined$CARRIER == "G4"
mat4 <- combined$CARRIER == "OH"
mat5 <- combined$CARRIER == "NK"
mat6 <- combined$CARRIER == "OO"
mat7 <- combined$CARRIER == "DL"
mat8 <- combined$CARRIER == "YV"
mat9 <- combined$CARRIER == "EV"
mat10 <- combined$CARRIER == "YX"
mat11 <- combined$CARRIER == "UA"
mat12 <- combined$CARRIER == "WN"
mat13 <- combined$CARRIER == "AS"
mat14 <- combined$CARRIER == "F9"
mat15 <- combined$CARRIER == "B6"


combined$CARRIER[mat0] <-  "AMERICAN"
combined$CARRIER[mat1] <-  "ENVOY"
combined$CARRIER[mat2] <- "EndeavoR"
combined$CARRIER[mat3] <- "Allegiant"
combined$CARRIER[mat4] <- "Comair"
combined$CARRIER[mat5] <- "Spirit"
combined$CARRIER[mat6] <- "SkyWest"
combined$CARRIER[mat7] <- "DeltA"
combined$CARRIER[mat8] <- "Mesa"
combined$CARRIER[mat9] <-  "ExpressJet" 
combined$CARRIER[mat10] <- "Republic"  
combined$CARRIER[mat11] <-  "United" 
combined$CARRIER[mat12] <-  "Southwest" 
combined$CARRIER[mat13] <-  "Alaska" 
combined$CARRIER[mat14] <-   "Frontier"
combined$CARRIER[mat15] <- "JetBlUE"

#Change cancellation codes to cancel reason

mat0 <- combined$CancelReason == "A"
mat1 <- combined$CancelReason == "B"
mat2 <- combined$CancelReason == "C"
mat3 <- combined$CancelReason == "D"

combined$CancelReason[mat0] <-  "Carrier"
combined$CancelReason[mat1] <- "Weather"
combined$CancelReason[mat2] <- "National Air System"
combined$CancelReason[mat3] <- "Security"
